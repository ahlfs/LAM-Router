...
func init() {
	...
	kiroClaude := Capabilities{Vision: true, Reasoning: true, Search: true, Tools: true}
	kiroCoder := Capabilities{Reasoning: true, Tools: true}
	providerCapabilities["kiro"] = map[string]Capabilities{
		"claude-sonnet-4.6":            kiroClaude,
		"claude-sonnet-4.6-thinking":   kiroClaude,
		"claude-opus-4.7":              kiroClaude,
		"claude-opus-4.7-thinking":     kiroClaude,
		"claude-sonnet-4.5":            kiroClaude,
		"claude-sonnet-4.5-thinking":   kiroClaude,
		"claude-3-7-sonnet":            kiroClaude,
		"claude-3-5-haiku":             kiroClaude,
		"qwen3-coder-next":             kiroCoder,
		"qwen3-coder":                  kiroCoder,
		"qwen2.5-coder-32b":            kiroCoder,
		"deepseek-v3.2":                kiroCoder,
		"deepseek-r1":                  kiroCoder,
		"minimax-m2.5":                 kiroCoder,
		"minimax-m2.1":                 kiroCoder,
		"glm-5":                        kiroCoder,
		"gpt-5.6-sol":                  kiroGpt56,
		"gpt-5.6-terra":                kiroGpt56,
		"gpt-5.6-luna":                 kiroGpt56,
		"gpt-5.6-sol-thinking":         kiroGpt56,
		"simple-task":                  Capabilities{Tools: true},
	}
}
